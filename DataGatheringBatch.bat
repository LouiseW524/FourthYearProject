...
cd C:/"Program Files (x86)"/Jenkins/workspace/"Fourth Year Project V1.1"/datasets/shubhmamp/english-premier-league-match-data && dir &&  C:/"Program Files"/7-Zip/7z x english-premier-league-match-data.zip